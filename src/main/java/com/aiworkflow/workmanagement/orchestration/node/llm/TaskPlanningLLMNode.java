...
public class TaskPlanningLLMNode extends AbstractLLMNodeAction {

    public TaskPlanningLLMNode(
    ...
    protected String buildPrompt(PromptTemplateService promptTemplateService, OrchestrationState state) {
        return promptTemplateService.buildTaskPlanningPrompt(state.toContext());
    }
